...
import hero from "../assets/privacyHero.png";
const Privacy = () => {
  return (
    <>
      <Banner img={hero} text="Privacy Policy" />
      <section className="resources">
        ...
        <p>
          ...
          details about your transfers with Sekundex or its partners, along with
          any trading actions, financial statements, previously asked questions
        ...
        <p>
          With the exception of the parties stated in the privacy protocol, No
        ...
        <p>
          You can choose if you want to share the necessary information with No
          Name 1 . Be mindful though, that any info you omit might lead to
