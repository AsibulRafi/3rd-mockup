      ...
      <section className="webTrader">
        ...
        <div className="webTrader__content">
          ...
          <div className="webTrader__content-info">
            <p>
              No Name 1`s highest purpose is to turn its clients into successful
            ...
            <p>
              No Name 1 grants you a gateway to all your trading needs with the
            ...
            <p>
              ...
              choose from a number of languages, it features the latest charts,
              fast operation of the trades, and best of all, it makes everything
        ...
        <div className="webTrader__text">
          <p>
            Due to the intuitiveness and easiness of use, the No Name 1 Online
          ...
          <p>
            ...
            react quickly in <br />
            such cases. With the No Name 1 Online Trader, you act accordingly
            and access your trades at any moment. The advantage is in your
            hands.
          </p>
          <p>
